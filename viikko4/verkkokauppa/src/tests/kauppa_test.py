...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_paatyttya_pankki_kutsuu_tilisiirto_oikealla_parametrilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_pankki_kutsuu_tilisiirto_oikealla_parametrilla_kaksi_eri_tuote(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            elif tuote_id == 2:
    ...
    def test_pankki_kutsuu_tilisiirto_oikealla_parametrilla_kaksi_sama_tuote(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_pankki_kutsuu_tilisiirto_oikealla_parametrilla_kaksi_sama_tuote_erimaara(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 2
            elif tuote_id == 2:
    ...
    def test_metodi_aloita_asiointi_nollaa_hinta_historian(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 2
    ...
    def test_viitegenraattiri_tuottaa_eri_viite_jokaiselle_ostoksille(self):
